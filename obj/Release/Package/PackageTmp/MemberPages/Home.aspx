...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:GridView ID="QRCodes" runat="server" AutoGenerateColumns="False" 
        ...
        AllowPaging="False" EnableViewState="False" CssClass="mGrid" AlternatingRowStyle-CssClass="alt" 
    ...
    <div>
        ...
        <asp:Button runat="server" id="UploadVideo" text="Upload Video" onclick="UploadVideo_Click" />
     </div>
</asp:Content>
